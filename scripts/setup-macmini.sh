...
echo "    Agent: ${SH_AGENT}"
echo "    日志: /var/log/hysteria-shanghai.log"
echo ""
echo "  HY2 Client (荷兰):"
echo "    配置: ${HYS_DIR}/netherlands.yaml"
echo "    Agent: ${NL_AGENT}"
echo "    日志: /var/log/hysteria-netherlands.log"
echo "    隧道: 127.0.0.1:9092 -> NL:22"
echo ""
echo "  OpenList:"
echo "    Agent: ${OPENLIST_PLIST}"
echo "    日志: /var/log/openlist.log"
echo ""
echo "  Rsync 回传:"
echo "    脚本: ${SCRIPTS_DIR}/pullback.sh"
echo "    频率: 每 ${RSYNC_INTERVAL} 分钟"
echo "    日志: ${LOG_FILE}"
...
echo ""
echo "  # 手动测试 rsync (需先确保 SSH 密钥已添加)"
